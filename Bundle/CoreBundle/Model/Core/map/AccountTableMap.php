...
class AccountTableMap extends \Eulogix\Cool\Lib\Database\Propel\CoolTableMap
{
     ...
     */
    const CLASS_NAME = 'vendor.eulogix.cool-core-bundle.Bundle.CoreBundle.Model.Core.map.AccountTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('office', 'Office', 'LONGVARCHAR', false, null, null);
        // validators
    } // initialize()
