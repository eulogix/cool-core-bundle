...
abstract class BaseAppLock extends CoolPropelObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Eulogix\\Cool\\Bundle\\CoreBundle\\Model\\Core\\AppLockPeer';
    ...
    /**
     * The value for the app_lock_id field.
     * @var        int
     */
    protected $app_lock_id;
    ...
    /**
     * Get the [app_lock_id] column value.
     *
     * @return int
     */
    public function getAppLockId()
    {

        return $this->app_lock_id;
    }
    ...
    /**
     * Set the value of [app_lock_id] column.
     *
     * @param  int $v new value
     * @return AppLock The current object (for fluent API support)
     */
    public function setAppLockId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->app_lock_id !== $v) {
            $this->app_lock_id = $v;
            $this->modifiedColumns[] = AppLockPeer::APP_LOCK_ID;
        }
    ...
    public function setReason($v)
    {
        ...
        if ($this->reason !== $v) {
            $this->reason = $v;
            $this->modifiedColumns[] = AppLockPeer::REASON;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[] = AppLockPeer::MESSAGE;
        }
    ...
    public function setFromDate($v)
    {
        ...
        if ($this->from_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AppLockPeer::FROM_DATE;
            }
    ...
    public function setToDate($v)
    {
        ...
        if ($this->to_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AppLockPeer::TO_DATE;
            }
        } // if either are not null
    ...
    public function setActiveFlag($v)
    {
        ...
        if ($this->active_flag !== $v) {
            $this->active_flag = $v;
            $this->modifiedColumns[] = AppLockPeer::ACTIVE_FLAG;
        }
    ...
    public function setMeta($v)
    {
        ...
        if ($this->meta !== $v) {
            $this->meta = $v;
            $this->modifiedColumns[] = AppLockPeer::META;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->app_lock_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->reason = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            $this->active_flag = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
            ...
            return $startcol + 7; // 7 = AppLockPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = AppLockPeer::APP_LOCK_ID;
        if (null !== $this->app_lock_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . AppLockPeer::APP_LOCK_ID . ')');
        }
        if (null === $this->app_lock_id) {
            try {
                $stmt = $con->query("SELECT nextval('core.app_lock_app_lock_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->app_lock_id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(AppLockPeer::APP_LOCK_ID)) {
            $modifiedColumns[':p' . $index++]  = 'app_lock_id';
        }
        if ($this->isColumnModified(AppLockPeer::REASON)) {
            $modifiedColumns[':p' . $index++]  = 'reason';
        }
        if ($this->isColumnModified(AppLockPeer::MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = 'message';
        }
        if ($this->isColumnModified(AppLockPeer::FROM_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'from_date';
        }
        if ($this->isColumnModified(AppLockPeer::TO_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'to_date';
        }
        if ($this->isColumnModified(AppLockPeer::ACTIVE_FLAG)) {
            $modifiedColumns[':p' . $index++]  = 'active_flag';
        }
        if ($this->isColumnModified(AppLockPeer::META)) {
            $modifiedColumns[':p' . $index++]  = 'meta';
        }

        $sql = sprintf(
            'INSERT INTO core.app_lock (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'app_lock_id':
                        $stmt->bindValue($identifier, $this->app_lock_id, PDO::PARAM_INT);
                        break;
                    case 'reason':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setAppLockId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setReason($arr[$keys[1]]);
        ...
        if (array_key_exists($keys[5], $arr)) $this->setActiveFlag($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AppLockPeer::APP_LOCK_ID)) $criteria->add(AppLockPeer::APP_LOCK_ID, $this->app_lock_id);
        if ($this->isColumnModified(AppLockPeer::REASON)) $criteria->add(AppLockPeer::REASON, $this->reason);
        if ($this->isColumnModified(AppLockPeer::MESSAGE)) $criteria->add(AppLockPeer::MESSAGE, $this->message);
        if ($this->isColumnModified(AppLockPeer::FROM_DATE)) $criteria->add(AppLockPeer::FROM_DATE, $this->from_date);
        if ($this->isColumnModified(AppLockPeer::TO_DATE)) $criteria->add(AppLockPeer::TO_DATE, $this->to_date);
        if ($this->isColumnModified(AppLockPeer::ACTIVE_FLAG)) $criteria->add(AppLockPeer::ACTIVE_FLAG, $this->active_flag);
        if ($this->isColumnModified(AppLockPeer::META)) $criteria->add(AppLockPeer::META, $this->meta);
    ...
    {
        $criteria = new Criteria(AppLockPeer::DATABASE_NAME);
        $criteria->add(AppLockPeer::APP_LOCK_ID, $this->app_lock_id);
    ...
    /**
     * Generic method to set the primary key (app_lock_id column).
     *
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setAppLockId(NULL); // this is a auto-increment column, so set to default value
        }
    }
