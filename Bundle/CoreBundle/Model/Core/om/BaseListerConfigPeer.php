...
abstract class BaseListerConfigPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('ListerConfigId', 'Name', 'Variation', 'FilterShowFlag', 'FilterServerId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('listerConfigId', 'name', 'variation', 'filterShowFlag', 'filterServerId', ),
        BasePeer::TYPE_COLNAME => array (ListerConfigPeer::LISTER_CONFIG_ID, ListerConfigPeer::NAME, ListerConfigPeer::VARIATION, ListerConfigPeer::FILTER_SHOW_FLAG, ListerConfigPeer::FILTER_SERVER_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('LISTER_CONFIG_ID', 'NAME', 'VARIATION', 'FILTER_SHOW_FLAG', 'FILTER_SERVER_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('lister_config_id', 'name', 'variation', 'filter_show_flag', 'filter_server_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('ListerConfigId' => 0, 'Name' => 1, 'Variation' => 2, 'FilterShowFlag' => 3, 'FilterServerId' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('listerConfigId' => 0, 'name' => 1, 'variation' => 2, 'filterShowFlag' => 3, 'filterServerId' => 4, ),
        BasePeer::TYPE_COLNAME => array (ListerConfigPeer::LISTER_CONFIG_ID => 0, ListerConfigPeer::NAME => 1, ListerConfigPeer::VARIATION => 2, ListerConfigPeer::FILTER_SHOW_FLAG => 3, ListerConfigPeer::FILTER_SERVER_ID => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('LISTER_CONFIG_ID' => 0, 'NAME' => 1, 'VARIATION' => 2, 'FILTER_SHOW_FLAG' => 3, 'FILTER_SERVER_ID' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('lister_config_id' => 0, 'name' => 1, 'variation' => 2, 'filter_show_flag' => 3, 'filter_server_id' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
