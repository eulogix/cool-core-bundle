...
abstract class BaseWidgetRulePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('WidgetRuleId', 'WidgetId', 'RuleId', 'Evaluation', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('widgetRuleId', 'widgetId', 'ruleId', 'evaluation', ),
        BasePeer::TYPE_COLNAME => array (WidgetRulePeer::WIDGET_RULE_ID, WidgetRulePeer::WIDGET_ID, WidgetRulePeer::RULE_ID, WidgetRulePeer::EVALUATION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('WIDGET_RULE_ID', 'WIDGET_ID', 'RULE_ID', 'EVALUATION', ),
        BasePeer::TYPE_FIELDNAME => array ('widget_rule_id', 'widget_id', 'rule_id', 'evaluation', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('WidgetRuleId' => 0, 'WidgetId' => 1, 'RuleId' => 2, 'Evaluation' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('widgetRuleId' => 0, 'widgetId' => 1, 'ruleId' => 2, 'evaluation' => 3, ),
        BasePeer::TYPE_COLNAME => array (WidgetRulePeer::WIDGET_RULE_ID => 0, WidgetRulePeer::WIDGET_ID => 1, WidgetRulePeer::RULE_ID => 2, WidgetRulePeer::EVALUATION => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('WIDGET_RULE_ID' => 0, 'WIDGET_ID' => 1, 'RULE_ID' => 2, 'EVALUATION' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('widget_rule_id' => 0, 'widget_id' => 1, 'rule_id' => 2, 'evaluation' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
