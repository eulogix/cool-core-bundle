define([
	...
	'cool/rfe/dialogs/DialogFileProperties',
	'cool/rfe/DialogConfirm'
	...
	return {
		...
		getByFileObj: function(type, fileObj) {
			...
			if (!dialog) {
				dialog = this.createDialog(type, id, { obj: fileObj });
			}
			return dialog;
		},
		 ...
		 * @returns {*}
		 */
		createDialog: function(type, id, args) {
			var dialog;
				...
				case 'deleteFile':
					...
					dialog = new DialogConfirm({
						...
						content: '<p>Do you really want to delete this ' + str + '?</p>' +
							'<img src="' + require.toUrl('cool/rfe/resources/images/icons-64/' + str + '.png') + '" alt="' + str + ' icon" class="dialogContentIconImg">' +
