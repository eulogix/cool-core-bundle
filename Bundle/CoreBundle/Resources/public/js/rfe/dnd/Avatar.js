...
function(window, array, declare, domConstruct, domClass, domAttr, Avatar) {
	...
	images.folder.src   = require.toUrl('cool/rfe/resources/images/icons-64/folder.png');
	images.files.src    = require.toUrl('cool/rfe/resources/images/icons-64/files.png');
	images.file.src     = require.toUrl('cool/rfe/resources/images/icons-64/file.png');
