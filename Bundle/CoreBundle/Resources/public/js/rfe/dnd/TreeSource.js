	...
	'cool/rfe/dnd/_SourceMixin'
		...
		return declare([dndSource, _SourceMixin], {
			...
			onDropExternal: function(sourceSource, nodes, copy, newParentObject) {
				...
				//TODO Ugly: had to change storeMemory for fileStore, as the memory store is buggy
				oldParentObject = fileStore.get(object[fileStore.parentAttr]);
